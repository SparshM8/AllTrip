...
import itineraryData from "@/data/itinerary-kongthong.json";

export default function OffbeatMeghalayaKongthongPage() {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, amount: 0.1 });

  const { dayWiseItinerary, travelTips, packageIncludes } = itineraryData;
        ...
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Card className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-gray-800 dark:to-gray-700 border-0 shadow-xl">
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                    ₹7,999 <span className="text-lg text-gray-500 dark:text-gray-400 line-through">₹9,999</span>
                  </div>
