      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-semibold text-gray-900 mb-4">Why Choose Jim Corbett?</h2>
            ...
            <h2 className="text-3xl font-semibold text-gray-900 mb-4">Safari Zones & Attractions</h2>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                <h3 className="text-xl font-semibold mb-2">Dhikala Zone</h3>
                <p>Core area with highest tiger density, diverse wildlife, and overnight forest rest houses.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Bijrani Zone</h3>
                <p>Popular day safari zone near Ramnagar with excellent wildlife sightings and accessibility.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Jhirna Zone</h3>
                <p>Open year-round zone offering consistent wildlife viewing and sloth bear sightings.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Durga Devi Zone</h3>
                <p>Peaceful zone with elephant safaris, bird watching, and beautiful river views.</p>
              </div>
            </div>
          </div>
        </div>
