      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-semibold text-gray-900 mb-4">Why Choose Himachal Pradesh?</h2>
            ...
            <h2 className="text-3xl font-semibold text-gray-900 mb-4">Popular Destinations</h2>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                <h3 className="text-xl font-semibold mb-2">Shimla</h3>
                <p>Former British summer capital with colonial architecture, Mall Road, and scenic toy train.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Manali</h3>
                <p>Adventure hub offering skiing, paragliding, and gateway to high-altitude destinations.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Dharamshala</h3>
                <p>Home to the Dalai Lama with McLeod Ganj, Tibetan culture, and beautiful mountain views.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Spiti Valley</h3>
                <p>High-altitude desert valley with ancient monasteries and dramatic landscapes.</p>
              </div>
            </div>
          </div>
        </div>
